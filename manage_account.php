                ...
                <div class="container-fluid">
                    <form id="register-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <select name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="Block 6 Lot 23, Here Subd., There City, Anywhere, 2306"><?= isset($address) ? $address : "" ?>
                            <option <?= isset($address) && $address == 'Tekun' ? "selected" : "" ?>>Tekun</option>
                            <option <?= isset($address) && $address == 'Saujana' ? "selected" : "" ?>>Saujana</option>
                            <option <?= isset($address) && $address == 'Restu' ? "selected" : "" ?>>Restu</option>
                            <option <?= isset($address) && $address == 'PETAS' ? "selected" : "" ?>>PETAS</option>
                        </select>
                            <small class="ml-3">Desasiswa</small>
                            
                            </div>
                        </div>
                        <div class="row">
           <div class="form-group col-md-12">
                <input type="text" name="desa_address" id="desa_address" placeholder="M05/University Height/PT12 Taman Desa Telipot" class="form-control form-control-sm form-control-border" required>
                <small class="ml-3">Desasiswa Address</small>
            </div>
                        <hr>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <input type="email" name="email" id="email" placeholder="jsmith@student.usm.my" class="form-control form-control-sm form-control-border" required value="<?= isset($email) ? $email : "" ?>">
                                <small class="ml-3">Student Email</small>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
