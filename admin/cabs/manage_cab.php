...
<div class="card card-outline card-purple rounded-0">
	...
	<div class="card-body">
		<form action="" id="cab-form">
			...
			<div class="form-group">
				<label for="username" class="control-label">Driver's Username</label>
                <textarea name="username" id="username" type="text" class="form-control rounded-0" required><?php echo isset($username) ? $username : ''; ?></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="driver_address" class="control-label">Driver's Desasiswa</label>
